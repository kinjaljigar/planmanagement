        ...
        <div class="row">
            <div class="col-lg-6"><h3 class="m-t-none m-b"></h3>
                ...
                <form id="stringLengthForm" class="form-horizontal"
                      ...
                      action="{{route('dealer.edit')}}" method="post">
                    {{csrf_field()}}

                    @include('flash-message')
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="txt_id" id="txt_id" value="{{$dealer->Id}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="txt_area" class="form-control"   id="txt_area" required>
                            ...
                            @foreach($area as $p )
                                ...
                                <option value="{{ $p->Id}}"
                                    {{$dealer->Area_Id==$p->Id?'Selected':''}}> {{$p->Area_Name}}</option>
                    ...
                    <div class="form-group">
                        <table>
                            ...
                            @foreach($Bottles as $b)
                                <tr>
                                    <td>{{$b->Name}}</td>
                                    <td><input type="text" class="form-control" id="txtB{{$b->Id}}"
                                               name="txtB{{$b->Id}}"
                                               value="{{$b->Rate1}}"> </td>
                                </tr>
                            @endforeach
