        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
					...
					<form id="frmEntry" method="post" action="{{route('rptDealerLedger.Show')}}" role="form" class="form-horizontal"> 
                    {{csrf_field()}}
                    
                    <div class="form-group">
                    	<label class="col-md-2">Dealer</label>
                    	<div class="col-md-6">
                        	<select name="cmbDealer" id="cmbDealer" required class="form-control">
                            	<option value="">--- Select Dealer ---</option>
                                @foreach($Dealer as $c)
                                	<option value="{{$c->Id}}" {{$c->Id==$Dealer_Sel?'Selected':''}} >
                                    {{$c->Dealer_Name}}</option>
                                @endforeach
                        	</select>
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                           	...
                           	<?php 
								...
								$Cr_Total=0;
							?>
							@if(is_null($Dealer_list))
                            @else
                            
		
							@foreach($Dealer_list as $a)
                                <tr>
