...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Edit Delivery Boy Base Bottle</h2>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Edit Delivery Boy Base Bottle</strong>
            </li>
        </ol>
        ...
        <div class="row">
            <div class="col-lg-6"><h3 class="m-t-none m-b"></h3>
                ...
                <form id="stringLengthForm" class="form-horizontal"
                      ...
                      action="{{route('DeliveryBoyBaseBottle.edit')}}" method="post">
                    {{csrf_field()}}

                    @include('flash-message')
                    <div class="form-group">
                        <input type="hidden" class="form-control" value="{{$dbbb->Id}}" name="txt_id">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="txt_deliveryboyid" id="txt_deliveryboyid" class="form-control" required>
                            ...
                            @foreach($deliveryboys as $c )
                                ...
                                <option value="{{ $c->Id}}"
                                    {{$dbbb->Delivery_Boy_Id==$c->Id?'Selected':''}}> {{$c->Boy_Name}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="txt_bottleid" id="txt_bottleid" class="form-control" required>
                            ...
                            @foreach($bottletypes as $p )
                                ...
                                <option value="{{ $p->Id}}"
                                    {{$dbbb->Bottle_Id==$p->Id?'Selected':''}}> {{$p->Name}}</option>
