...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Add Bottle Type Master</strong>
            </li>
        </ol>
        ...
        <div class="row">
            <div class="col-lg-6"><h3 class="m-t-none m-b"></h3>
                ...
                <form id="stringLengthForm" class="form-horizontal"
                      ...
                      action="{{route('bottletype.store')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div>
						...
						<div class="form-group"><label>Used By <span style="color:red">*</span></label>
                            <select id="txt_user" name="txt_user" class="form-control" required>
                            	<option value="DB" {{old("tx_user")=="DB"?'Selected':''}}>Dealivery Boy</option>
                                <option value="Dealer" {{old("tx_user")=="Dealer"?'Selected':''}>Dealer</option>
                            </select>
                        </div>
