...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Add Dealer Plan Relation</h2>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Add Dealer Plan Relation</strong>
            </li>
        </ol>
        ...
        <div class="row">
            <div class="col-lg-6"><h3 class="m-t-none m-b"></h3>
                ...
                <form id="stringLengthForm" class="form-horizontal"
                      ...
                      action="{{route('DealerPlanRel.store')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <select name="txt_dealerid" id="txt_dealerid" class="form-control" required>
                            ...
                            @foreach($dealers as $d)
                                ...
                                <option value="{{ $d->Id}}"
                                    {{old('txt_dealerid')==$d->Id?'Selected':''}}> {{$d->Dealer_Name}}</option>
