        ...
        <div class="row">
            ...
            <div class="col-lg-6"><h3 class="m-t-none m-b"></h3>
                ...
                <form id="stringLengthForm" class="form-horizontal"
                      ...
                      action="{{route('area.edit')}}" method="post">
                    ...
                    @include('flash-message')
                        ...
                        <input type="hidden" name="txt_id" value="{{$area->Id}}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="txt_cityid" class="form-control"  id="txt_cityid" required>
                            ...
                            @foreach($city as $p )
                                ...
                                <option value="{{ $p->Id}}"
                                    {{$area->City_Id==$p->Id?'Selected':''}}> {{$p->City_Name}}</option>
                    ...
                    <div class="form-group"><label>Area <span style="color: red">*</span></label>
                        <input type="text"
