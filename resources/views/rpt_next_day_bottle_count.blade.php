    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                ...
                <strong>Next Day Bottle Coout</strong>
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
					...
					<form id="frmEntry" method="post" action="{{route('rptNextDayBottleCount.list.Show')}}" role="form">
                    {{csrf_field()}}
                ...
                $(document).ready(function(){
                    ...
                    $('.dataTables-example').DataTable({
                        ...
                        buttons: [
                            ...
                            {extend: 'csv',title:'Bottles Required on : ' ,exportOptions: {
                                    
                                }},

                            {extend: 'excel',title:'Bottles Required on : ' ,exportOptions: {
                                    
                                }},

                            {extend: 'pdf',title:'Bottles Required on : ',exportOptions: {
                                    
                                }},



                            {extend: 'print',title:'Bottles Required on : ',
