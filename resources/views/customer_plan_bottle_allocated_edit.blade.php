...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Edit Customer Plan Bottle Allocated</h2>
        ...
        <div class="row">
            <div class="col-lg-6"><h3 class="m-t-none m-b"></h3>
                ...
                <form id="stringLengthForm" class="form-horizontal"
                      ...
                      action="{{route('CustPlanBottleAlloc.edit')}}" method="post">
                    {{csrf_field()}}

                    @include('flash-message')

                    <input type="hidden" name="txt_id" value="{{$custplanbottallo->Id}}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="txt_customerplanid" id="txt_customerplanid" class="form-control" required>
                            ...
                            @foreach($customers as $p )
                                ...
                                <option value="{{ $p->Id}}"
                                    {{$custplanbottallo->Cust_Plan_Id==$p->Id?'Selected':''}}>{{$p->name}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="txt_bottleid" id="txt_bottleid" class="form-control" required>
                            ...
                            @foreach($bottles as $p )
                                ...
                                <option value="{{ $p->Id}}"
                                    {{$custplanbottallo->Bottle_Id==$p->Id?'Selected':''}}>{{$p->Name}}</option>
                    ...
                    <div class="form-group"><label>Number Of Bottle</label>
                        <input type="number"
                               ...
                               id="txt_bottleno"
                               class="form-control"
                               value="{{$custplanbottallo->No_Of_Bottles}}"
                               required></div>
