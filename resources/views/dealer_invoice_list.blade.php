                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            @foreach($Invoice as $d)
                                ...
                                <tr>
                                	<td>{{$d->Invoice_No}}</td>
									<th>{{$d->Month1}}/{{$d->Year1}}</th>
                                    <th>{{$d->Agency_Name}}</th>
                                    <th>{{$d->Dealer_Name}}</th>
                                    <th>{{$d->Phone_No}}</th>
                                    <th>{{$d->Area_Name}}</th>
                                    <th>{{$d->Amount}}</th>
                                    <!--<th><input type="checkbox" {{$d->isPaid==true?'checked="checked"':''}} disabled></th>-->
                                    <td align="center"><a href="{{url('DealerPaymentCollection/'.$d->Id)}}" >
                                            <i class="fa fa-money" style="font-size: large"></i></a></td>

                                    <td align="center"><a href="{{url('DealerInvoicePrint/'.$d->Id)}}" >
